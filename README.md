...
### Techonologies: 
  - Hardhat, Moralis, OpenZeppelin, CoinmarketCap API
  - React, Next.js, Tailwind.css

The project consists of 4 contracts deployed and swapped with each other. 

It was done to learn how to interact with Moralis, working with Multichains (ETH, BSC, POLYGON and AVAX), and Storing Basic information, and also creating a DB to store Coins (USDC, DOGE, LINK, DAI).
